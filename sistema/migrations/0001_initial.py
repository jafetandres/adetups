# Generated by Django 3.1.2 on 2021-01-16 16:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cuota', models.DecimalField(decimal_places=2, max_digits=9)),
                ('interes', models.DecimalField(decimal_places=2, max_digits=9)),
                ('porcinteres', models.DecimalField(decimal_places=2, max_digits=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('socio', models.CharField(max_length=10, verbose_name=sistema.models.Socio)),
                ('fecha', models.DateTimeField(auto_now=True)),
                ('valor', models.DecimalField(db_column='RSOVALOR', decimal_places=2, max_digits=9)),
                ('estado', models.CharField(db_column='RSOESTADO', max_length=3)),
                ('rubro', models.ForeignKey(db_column='RUBCODIGO', on_delete=django.db.models.deletion.DO_NOTHING, to='sistema.rubro')),
            ],
        ),
        migrations.CreateModel(
