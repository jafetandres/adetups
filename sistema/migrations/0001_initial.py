# Generated by Django 3.1.2 on 2021-02-05 19:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clasecredito', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='sistema.clasecredito')),
                ('garante', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='garante', to='sistema.socio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tiempo_desde', models.IntegerField(blank=True, null=True)),
                ('tiempo_hasta', models.IntegerField(blank=True, null=True)),
                ('valhasta', models.DecimalField(blank=True, decimal_places=2, max_digits=6, null=True)),
                ('estado', models.BooleanField(blank=True, default=True, null=True)),
